...
const Footer = () => {
  return (
    <div className="bg-darkNavy selsf-stretch flex justify-center py-14 text-xs">
      <div className="container relative mx-auto p-8">
        <div className="mx-auto flex max-w-[98%] flex-col items-start justify-between lg:flex-row lg:gap-x-10 lg:self-center">
          <div className="flex flex-1 flex-col gap-32">
            ...
            <div className="divide-purple flex divide-x-2">
          ...
          <div className="flex flex-1 flex-col gap-14">
            <div className="flex flex-col gap-3">
              <h3 className="text-purple mb-1 mt-5 text-start font-semibold">
                Useful Links
              </h3>
        ...
        <img src={star1} className="absolute left-1 top-20 h-2 w-2" alt="" />
        <img
          src={star}
          className="absolute bottom-96 right-24 h-3 w-3"
          alt=""
        />
        <img
          src={starp}
          className="absolute bottom-16  left-24 h-[0.375rem] w-[0.375rem]"
          alt=""
        />
        <img
          src={star1}
